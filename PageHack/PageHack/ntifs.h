...
#define vKdPrintEx(_x_) v;//DbgPrintEx _x_
#define vKdPrintExWithPrefix(_x_) v;//DbgPrintExWithPrefix _x_
// begin_wdm
...
typedef struct _SERVICE_DESCRIPTOR_TABLE2 
{
...
SERVICE_DESCRIPTOR_TABLE2, *PSERVICE_DESCRIPTOR_TABLE2;
